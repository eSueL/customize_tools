...
class CusAdaptiveTextSelectionToolbar extends StatelessWidget {
  ...
  /// {@endtemplate}
  const CusAdaptiveTextSelectionToolbar({
    super.key,
  ...
  const CusAdaptiveTextSelectionToolbar.buttonItems({
    super.key,
  ...
  /// {@macro flutter.material.AdaptiveTextSelectionToolbar.selectable}
  CusAdaptiveTextSelectionToolbar.editable({
    super.key,
  ...
  /// {@macro flutter.material.AdaptiveTextSelectionToolbar.buttonItems}
  /// {@macro flutter.material.AdaptiveTextSelectionToolbar.selectable}
  CusAdaptiveTextSelectionToolbar.editableText({
    super.key,
  ...
  /// {@macro flutter.material.AdaptiveTextSelectionToolbar.editable}
  /// {@macro flutter.material.AdaptiveTextSelectionToolbar.editableText}
  CusAdaptiveTextSelectionToolbar.selectable({
    super.key,
    required VoidCallback onCopy,
    required VoidCallback onSelectAll,
  ...
  /// {@macro flutter.material.AdaptiveTextSelectionToolbar.editableText}
  /// {@macro flutter.material.AdaptiveTextSelectionToolbar.selectable}
  CusAdaptiveTextSelectionToolbar.selectableRegion({
    super.key,
    required CusSelectableRegionState selectableRegionState,
  }) : children = null,
