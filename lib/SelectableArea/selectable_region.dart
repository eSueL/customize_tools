...
class CusSelectableRegion extends StatefulWidget {
  ...
  final CusSelectableRegionContextMenuBuilder? contextMenuBuilder;
  ...
  /// Called
  final Function(SelectionChangedCause cause)? gestureOnCallback;
  ...
  @override
  State<StatefulWidget> createState() => CusSelectableRegionState();
}

/// State for a [SelectableRegion].
class CusSelectableRegionState extends State<CusSelectableRegion> with TextSelectionDelegate implements SelectionRegistrar {
  ...
  @override
  void didUpdateWidget(CusSelectableRegion oldWidget) {
 ...
 void _onAnyDragEnd(DragEndDetails details) {
  ...
  @Deprecated(
    'Use `contextMenuBuilder` instead. '
    'This feature was deprecated after v3.3.0-0.5.'
  )
  @override
...
class _SelectAllAction extends _NonOverrideAction<SelectAllTextIntent> {
  ...
  final CusSelectableRegionState state;
...
///    [EditableText].
typedef CusSelectableRegionContextMenuBuilder = Widget Function(
  BuildContext context,
  CusSelectableRegionState selectableRegionState,
);
