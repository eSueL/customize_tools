...
typedef CusCupertinoToolbarBuilder = Widget Function(
...
///    toolbar.
class CusCupertinoTextSelectionToolbar extends StatelessWidget {
  /// Creates an instance of CupertinoTextSelectionToolbar.
  const CusCupertinoTextSelectionToolbar({
    super.key,
  ...
  void paint(PaintingContext context, Offset offset) {
    visitChildren((RenderObject renderObjectChild) {
      ...
      if (childParentData.shouldPaint) {
        final Offset childOffset = childParentData.offset + offset + const Offset(0,5);
